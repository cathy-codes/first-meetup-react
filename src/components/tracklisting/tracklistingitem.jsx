export default function TrackListingItem({track}) {
    ...
    return(
        <div className="bg-gray-800 p-4 rounded relative">
            ...
            <div className="text-left">
                <h3 className="text-md font-bold mb-1 text-white">{track.title}</h3>
                <p className="text-sm mb-2 text-gray-400">By {track.artist}</p>
